 ...
 * - pattern (leaf): plain text in the same branch color as its ancestors,
 *   unbadged. Tapping navigates to the pattern page.
 */
    ...
    >
      ...
      {kind === 'root' ? (
        ...
        <div className="flex items-center gap-1.5">
          <span className={isLeaf ? 'text-xs font-medium' : 'text-sm font-bold'} style={{ color }}>
            {label}
          </span>
          {hasChildren && (
            <span
